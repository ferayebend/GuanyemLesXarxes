...
def getFollowers(user):
    followers = []
    f = open(user+'_follower.txt')
    for lines in f:
	followers.append(lines.strip())
    return followers
...
def GrabFollowerData(account_name):
    followers = get_users(account_name + '_follower.txt')
...
if __name__ == "__main__":
    ...
    #users = get_users('userlistGuanyem.txt')
    
    #followers = get_users('guanyem_follower.txt')
